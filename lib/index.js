...
var _resolveChainCall = require('./resolveChainCall');

var _resolveChainCall2 = _interopRequireDefault(_resolveChainCall);
          ...
          (0, _each3.default)(binding.referencePaths, function (refPath) {
            ...
            if (imported && imported != 'default') {
              if (isLodash && imported == 'chain' && parentPath.isCallExpression()) {
                (0, _resolveChainCall2.default)(pkgStore, parentPath);
              } else {
              ...
              if (isLodash && key == 'chain' && parentPath.parentPath.isCallExpression()) {
                (0, _resolveChainCall2.default)(pkgStore, parentPath.parentPath);
              } else {
